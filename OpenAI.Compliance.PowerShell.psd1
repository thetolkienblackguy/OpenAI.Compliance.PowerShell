@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = "v0.0.4 - Added log file management cmdlets (Get-OAILogFile, Get-OAILogFileContent), user conversation querying (Get-OAIUserConversation), batch processing controls, and enhanced pipeline support across cmdlets."
        }
    }
}
